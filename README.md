...
- [x] Setting up the initial user profile under account settings for a new user
- [x] Setting up address in account setting menu for a new user
- [x] With created account continue on and create cases for scenarios as an existing user signing in and editing the fields in above sections from set up. 
